...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://q8pwg0l66i.execute-api.us-east-1.amazonaws.com/beta';
    ...
    apigClient.searchOptions = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Access-Control-Allow-Origin', 'Access-Control-Allow-Headers', 'Access-Control-Allow-Methods', 'q'], ['body']);
